...
/**
 * The provider registry. Free tiers first, in the order they tend to be
 * worth using. `AI_PROVIDERS` (comma-separated ids) overrides the order.
 */
...
export const openrouter = createCompatibleProvider({
  ...
  extraHeaders: { "HTTP-Referer": "https://ideako.vercel.app", "X-Title": "Ideako" },
...
/** Providers that have a key, in preference order. */
